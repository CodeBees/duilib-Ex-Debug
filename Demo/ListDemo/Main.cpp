...
public:
    ...
    void Init() 
    {
		CShadowWindow::Initialize(m_pm.GetInstance());
		m_WndShadow.Create(m_hWnd);
		m_WndShadow.SetSize(20);
...
private:
	CShadowWindow m_WndShadow;//redrain
...
int APIENTRY WinMain(HINSTANCE hInstance, HINSTANCE /*hPrevInstance*/, LPSTR /*lpCmdLine*/, int nCmdShow)
{
	...
	CPaintManagerUI::SetCompressedPacketResource(_T("ListRes.zip"));
