...
public:
    ...
    void Init() {
        ...
        CComboUI* pAccountCombo = dynamic_cast<CComboUI*>(m_pm.FindControl(_T("accountcombo")));
        CEditUI* pAccountEdit = dynamic_cast<CEditUI*>(m_pm.FindControl(_T("accountedit")));
    ...
    LRESULT OnNcHitTest(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
    {
        ...
        if( pt.x >= rcClient.left + rcCaption.left && pt.x < rcClient.right - rcCaption.right \
            && pt.y >= rcCaption.top && pt.y < rcCaption.bottom ) {
                CControlUI* pControl = dynamic_cast<CControlUI*>(m_pm.FindControl(pt));
    ...
    LRESULT MessageHandler(UINT uMsg, WPARAM wParam, LPARAM lParam, bool& bHandled)
    {
        if( uMsg == WM_KEYDOWN ) {
            if( wParam == VK_RETURN ) {
                CEditUI* pEdit = dynamic_cast<CEditUI*>(m_pm.FindControl(_T("accountedit")));
                if( pEdit->GetText().IsEmpty() ) pEdit->SetFocus();
                else {
                    pEdit = dynamic_cast<CEditUI*>(m_pm.FindControl(_T("pwdedit")));
                    if( pEdit->GetText().IsEmpty() ) pEdit->SetFocus();
                    else Close();
                }
                return true;
...
public:
    ...
    void Init() {
        m_pCloseBtn = dynamic_cast<CButtonUI*>(m_pm.FindControl(_T("closebtn")));
        m_pMaxBtn = dynamic_cast<CButtonUI*>(m_pm.FindControl(_T("maxbtn")));
        m_pRestoreBtn = dynamic_cast<CButtonUI*>(m_pm.FindControl(_T("restorebtn")));
        m_pMinBtn = dynamic_cast<CButtonUI*>(m_pm.FindControl(_T("minbtn")));

		

        CActiveXUI* pActiveXUI = dynamic_cast<CActiveXUI*>(m_pm.FindControl(_T("ie")));
        if( pActiveXUI )
		{
    ...
    void OnPrepare() { 
        GameListUI* pGameList = dynamic_cast<GameListUI*>(m_pm.FindControl(_T("gamelist")));
        ...
        CListUI* pUserList = dynamic_cast<CListUI*>(m_pm.FindControl(_T("userlist")));
    ...
    void SendChatMessage() {
        CEditUI* pChatEdit = dynamic_cast<CEditUI*>(m_pm.FindControl(_T("chatEdit")));
        if( pChatEdit == NULL ) return;
        pChatEdit->SetFocus();
        if( pChatEdit->GetText().IsEmpty() ) return;

        CRichEditUI* pRichEdit = dynamic_cast<CRichEditUI*>(m_pm.FindControl(_T("chatmsglist")));
    ...
    void Notify(TNotifyUI& msg)
    {
        if( msg.sType == _T("windowinit") ) OnPrepare();
            ...
            if( msg.pSender == m_pCloseBtn ) { 
                COptionUI* pControl = dynamic_cast<COptionUI*>(m_pm.FindControl(_T("hallswitch")));
            ...
            if( name == _T("quitbtn") ) {
                ...
                COptionUI* pControl = dynamic_cast<COptionUI*>(m_pm.FindControl(_T("hallswitch")));
                pControl->Activate();
                CHorizontalLayoutUI* pH = dynamic_cast<CHorizontalLayoutUI*>(m_pm.FindControl(_T("roomswitchpanel")));
            ...
            if( name == _T("hallswitch") ) {
                ...
                if( pControl && pControl->GetCurSel() != 1 ) {
                    ...
                    DeskListUI* pDeskList = dynamic_cast<DeskListUI*>(m_pm.FindControl(_T("destlist")));
                    pDeskList->SetFocus();
                    CRichEditUI* pRichEdit = dynamic_cast<CRichEditUI*>(m_pm.FindControl(_T("chatmsglist")));
                    if( pRichEdit ) {
            ...
            if( pGameList->GetItemIndex(msg.pSender) != -1 )
            {
                if( _tcscmp(msg.pSender->GetClass(), _T("ListLabelElementUI")) == 0 ) {
                    ...
                    if( node->data()._level == 3 ) {
                        COptionUI* pControl = dynamic_cast<COptionUI*>(m_pm.FindControl(_T("roomswitch")));
                        if( pControl ) {
                            CHorizontalLayoutUI* pH = dynamic_cast<CHorizontalLayoutUI*>(m_pm.FindControl(_T("roomswitchpanel")));
            ...
            if( msg.pSender->GetName() == _T("chatCombo") ) {
                ...
                dynamic_cast<CComboUI*>(msg.pSender)->SelectItem(-1);
            }
        }
    ...
    LRESULT OnSysCommand(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
    {
        ...
        if( ::IsZoomed(*this) != bZoomed ) {
            if( !bZoomed ) {
                CControlUI* pControl = dynamic_cast<CControlUI*>(m_pm.FindControl(_T("maxbtn")));
                if( pControl ) pControl->SetVisible(false);
                pControl = dynamic_cast<CControlUI*>(m_pm.FindControl(_T("restorebtn")));
...
int APIENTRY WinMain(HINSTANCE hInstance, HINSTANCE /*hPrevInstance*/, LPSTR /*lpCmdLine*/, int nCmdShow)
{
   ...
   // CPaintManagerUI::SetResourceZip);
	CPaintManagerUI::SetCompressedPacketResource(_T("GameRes.zip"));
